...
| 文档 | 用途 |
|---|---|
| `AGENTS.md` | AI 协作规则总入口（所有 AI 工具/新程序员先读这个） |
| `CURRENT_STATE.md` | 项目当前状态唯一真相（版本/部署/数据库/已知风险） |
| `PROJECT_CONTEXT.md` | 业务背景（系统解决什么问题） |
| `docs/architecture/ARCHITECTURE.md` | 技术架构与数据流 |
| `docs/engineering/AI_HANDOFF.md` | AI/新人接手项目的标准流程 |
| `docs/engineering/CRITICAL_BUSINESS_RULES.md` | 不可破坏的业务规则 |
| `docs/engineering/CRITICAL_AREAS.md` | 危险区分级（哪里不能随便改） |
| `docs/architecture/decisions/` | ADR 架构决策记录（重要技术决策的档案） |
| `HANDOFF.md` | 历史会话交接记录（[Historical]，供查阅） |
...
### 4. 技术与安全
- 响应式设计，支持PC端和移动端
- 密码 bcrypt 哈希存储 + JWT 鉴权，支持匿名测评保护隐私
- 完善的权限管理系统
- 系统稳定性和可扩展性
